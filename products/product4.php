...
$productName = 'AI Analytics Suite';
...
<body>
  ...
  <main class="container">
    <section class="product-card">
      ...
      <p>AI-powered analytics engine for predictive maintenance, anomaly detection, and intelligent data-driven optimization.</p>

      <!-- ✅ Image added (same Unsplash image from products.html) -->
