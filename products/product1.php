...
<body>
  ...
  <main class="container">
    <section class="product-card">
      ...
      <p>IoT-enabled smart meter offering precise water-usage analytics, leak alerts, and automated reporting to the InnoByte Cloud Dashboard.</p>
      <img src="https://images.unsplash.com/photo-1603791440384-56cd371ee9a7?auto=format&fit=crop&w=1200&q=80" alt="<?= htmlspecialchars($productName) ?>">
      <div class="buttons">
