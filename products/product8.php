...
<body>
  ...
  <main class="container">
    <section class="product-card">
      ...
      <p class="price">From $349</p>
      <p>Smart device that tracks energy consumption patterns and optimizes electricity usage across industrial systems.</p>
