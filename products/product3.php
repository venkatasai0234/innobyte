...
:root{
  ...
  --accent:#3b82f6;--accent-2:#22c1a7;--highlight:#f97316;--radius:16px;
}
...
/* ===== PRODUCT ===== */
.product-card{background:rgba(255,255,255,0.8);border-radius:var(--radius);
  backdrop-filter:blur(10px)saturate(160%);box-shadow:0 10px 30px rgba(0,0,0,0.15);
  padding:40px;margin-top:60px;text-align:center;}
.product-card h1{background:linear-gradient(90deg,var(--accent),var(--highlight),var(--accent-2));
  -webkit-background-clip:text;-webkit-text-fill-color:transparent;
  font-size:2rem;font-weight:800;margin-bottom:12px;}
.price{color:var(--accent);font-weight:700;margin-bottom:10px}
.product-card p{color:var(--muted);margin-bottom:16px;font-size:1rem}
img{width:100%;max-width:700px;border-radius:var(--radius);
  box-shadow:0 6px 18px rgba(0,0,0,0.15);margin:20px 0}
.buttons{margin-top:20px}
a.btn{text-decoration:none;font-weight:700;color:#fff;padding:12px 24px;
  border-radius:999px;transition:.3s;display:inline-block;margin:6px}
...
a.btn:hover{transform:translateY(-3px);box-shadow:0 4px 14px rgba(0,0,0,0.25)}
footer{margin-top:80px;padding:24px;color:var(--muted);font-size:14px;text-align:center;
  border-top:1px solid #e2e8f0;background:rgba(255,255,255,0.85);
  backdrop-filter:blur(8px);border-radius:12px;box-shadow:0 -2px 12px rgba(0,0,0,0.05)}
</style>
</head>
...
<body>
  ...
  <main class="container">
    <section class="product-card">
      ...
      <p>Comprehensive cloud platform providing real-time IoT monitoring, analytics dashboards, data visualization, and secure device control across enterprise networks.</p>
      <img src="https://images.unsplash.com/photo-1555949963-aa79dcee981c?auto=format&fit=crop&w=1200&q=80" alt="<?= htmlspecialchars($productName) ?>">
      <div class="buttons">
