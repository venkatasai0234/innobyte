...
$productName = 'Data API Service';
$productLink = 'product9.php';
...
<body>
  ...
  <main class="container">
    <section class="product-card">
      ...
      <p class="price">From $599/year</p>
      <p>RESTful API suite to integrate InnoByte IoT data streams into external ERP, CRM, or analytics systems.</p>

      <!-- ✅ Product image -->
      <img src="https://images.unsplash.com/photo-1518779578993-ec3579fee39f?auto=format&fit=crop&w=1200&q=80"
