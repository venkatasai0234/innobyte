...
$productName = 'Leak Detection Sensor';
$productLink = 'product7.php';
...
<body>
  ...
  <main class="container">
    <section class="product-card">
      ...
      <p>Ultra-sensitive IoT-enabled sensor to detect and alert on water leaks in pipelines or equipment.</p>

      <!-- ✅ Product Image -->
      <img src="https://images.unsplash.com/photo-1581091870633-1f9a6f6f2d2f?auto=format&fit=crop&w=1200&q=80"
